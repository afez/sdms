        ...
        <header class = "panel-heading">
            <?php if ((User::loggedUser()->role_id != 2) AND ( User::loggedUser()->role_id != 3) AND ( User::loggedUser()->role_id != 7)) : ?>
                <div class = "pull-right">
                    <a href = "<?php echo $this->createUrl('/college/college/create'); ?>"> <button type = "button" class = "btn btn-primary"><i class = "fa fa-plus-square"></i> Add New College </button></a>

                </div>


            <?php endif; ?>
            <h4 style = "color: black ">UDSM Colleges </h4>
                        ...
                        <tr>
                            ...
                            <?php if ((User::loggedUser()->role_id != 2) AND ( User::loggedUser()->role_id != 3) AND ( User::loggedUser()->role_id != 7)) : ?>
                                <td class="center">
                                    ...
                                    <a class="btn btn-primary" href="<?php echo Yii::app()->createUrl('/college/college/update/id/' . $model->id) ?>">

    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('create', 'update', 'delete', 'index', 'profile','changepassword','report','reviewer'),
                'users' => array('@'),
            ),
...
//
//               if ($model->save())
//                    $this->redirect(array('changepassword', 'msg' => 'successfully changed password'));                else
...
//      }
     ...
     * Lists all models.
     */
    public function actionReviewer($id){
        $model=  User::model()->findAllByAttributes(["role_id"=>7]);
